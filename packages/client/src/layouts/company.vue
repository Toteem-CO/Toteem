<template>
  <section class="grid grid-cols-[15rem,1fr] grid-rows-[4rem,1fr] min-h-screen">
    <!-- LEFT MENU -->
    <section class="col-start-1 row-start-1 col-span-1 row-span-2 bg-base-100 z-50 w-[15rem]">
      <SharedLeftMenu />
    </section>
...
<script setup>
const companyLeftMenuItems = useCompanyLeftMenuItems();
